...
(function () {
    ...
    fileURL = window.UEDITOR_FILE_URL||URL;
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:fileURL+"imageUp"             //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:fileURL+"scrawlUp"           //涂鸦上传地址
        ,scrawlPath:""                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:fileURL+"fileUp"               //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:fileURL +"getRemoteImage"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:fileURL + "imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: fileURL +"imageUp" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: ""
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:fileURL + "imageUp"             //word转存提交地址
        ,wordImagePath:""                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:fileURL+"getMovie"                   //视频数据获取地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace','help','selectstyle','usehtml']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
        ,labelMap:{
            'anchor':'', 'undo':'','selectstyle':'应用样式','usehtml':'应用源码'
        }
        //webAppKey
...
//          ]
        ...
        //每一个对象就是一个自定义的样式
        ,'customstyle':[
              {tag:'h1', name:'流程序列','class':'h1step', label:'流程序列', style:''},
              {tag:'span', name:'流程序列-数字','class':'span_num', label:'流程序列-数字', style:''},
              {tag:'p', name:'注意事项','class':'ptip',label:'注意事项', style:''},
              {tag:'p', name:'分段间隔','class':'p_grap', label:'分段间隔', style:''},
              {tag:'p', name:'大标题','class':'big_title', label:'大标题', style:''},
              {tag:'p', name:'小标题','class':'little_title', label:'小标题', style:''},
              {tag:'p', name:'问题','class':'faq_q', label:'问题', style:''},
              {tag:'p', name:'答案','class':'faq_a', label:'答案', style:''}
          ]
