	<%@ page language="java" contentType="text/html; charset=utf-8"	pageEncoding="utf-8"%>
		...
		<title>融友网-您身边的互联网金融理财借贷信息服务平台-P2P理财</title>
		<meta name="keywords" content="理财借贷,小额贷款,安全贷款,p2p借贷,P2P理财,P2P网站,同城借贷,个人理财,债权转让,理财计划,网络贷款,网贷,网络理财">
		<meta name="description" content="融友网-您身边的互联网金融信息服务平台，中国极具潜力的O2O互联网金融平台，以风控第一为公司置业警钟，实地审核为业务根本，为投资理财用户和贷款用户提供诚信、公平、公正、安全、透明的股联网金融服务。投资理财用户在融友网平台通过筛选标的类型和详情进行投资散标、融友精选获得高收益；借贷用户通过平台申请一般借款和经营借款等小额贷款。">
		<meta name="baidu-site-verification" content="C90FW7dF06" />
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<link rel="stylesheet" href="/Statics/Home/css/animate.css">

		<!-- 360友好链接 -->
		<script type="text/javascript" src="http://links.webscan.360.cn/index/index/0f3954a74afa1093f1d4626167df2f31"></script>
		<a style="display:none;" href="http://webscan.360.cn/index/checkwebsite/url/www.p2pok.com"><img border="0" src="http://img.webscan.360.cn/status/pai/hash/e347cc27a2ba95e51bb4d566cc41c7e2"/></a>
		<!--百度流量统计代码-->
		<script>
		var _hmt = _hmt || [];
		(function() {
		...
		<a href="${dfn:U('home/invest/index')}" target="_blank">
		<div class="ry_4 tc">
		...
		<a href="${dfn:U('home/loan/index')}" target="_blank">
		<div class="ry_4 tc">
		...
		<a href="${dfn:U('home/safe/index')}" target="_blank">
		<div class="ry_4 tc">
		...
		<a href="${dfn:U('home/page/content')}'?i=fk" target="_blank">
		<div class="ry_4 tc">
		...
		<a class="ry_more_news" href="${_WEB_ROOT_}/category/index.do?id=427" target="_blank" style="margin-top:3px;">更多公告</a>
		</div>
        </c:if>
        </c:forEach>
        </c:if>
		...
		<a href="${user.url}" target="_blank"><img src="${dfn:getThumbImgUrl(user['thumburl'])}" width="74px" height="59px" onerror="javascript:imgOnError();"></a>
		</div>
		<div class="au_c_list_r fl">
		<p class="au_c_ft">${user.add_time}</p>
		<div><a href="${user.url}" target="_blank">${user['title']}</a></div>
		</div>
		</div>
		<!--  -->
		</c:forEach>
		...
		<a href="${dfn:U('home/category/index')}?id=389" target="_blank">更多》</a>
		</p>
		</div>
		</div>
		<!-- end 公司动态-->
		...
		<ul class="au_news">
		<li><a href="${user.url}" target="_blank">${user['title']}</a></li>
		</ul>
		</c:forEach>
		</c:if>
		<p class="au_l_more ">
		<a href="${dfn:U('home/category/index')}?id=427" target="_blank">更多》</a>
		</p>
		</div>
		</div>
		<!-- end 网站公告-->
		...
		<!-- end 关于我们 -->
		<div class="black20"></div>
		<h2 class="intro_tit">媒体报道<p style="font-size:14px; color:#707070;">权威的报道，记录行进中的<a href="http://www.p2pok.com/category/index.do?id=425" target="_blank" style="text-decoration:underline;font-size:14px; color:#707070;">融友网 >></a></p></h2>
		<div class="black20"></div>
		...
		<div id="scrollbox">
		<div class="ry_box">
		<img src="${HomeStatics}/images/ry_wangyi.png">
		<a href="http://www.p2pok.com/article/index.do?id=683" target="_blank">
		<p class="ry_p1">
		“万事万物都有尊严，金钱也不例外。选择权、知情权和议价权，这是初步构成金钱尊严的三个方面。当金钱的尊严被大众认知认可时，我们可以说，金钱就有了尊严。”近日，在一场题为“金钱的尊严”的沙龙上，互联网金融创业者、融友网总裁温哲屹说。
		</p>
		</a>
		</div>
		<div class="ry_box">
		<img src="${HomeStatics}/images/xinlang.png">
		<a href="http://www.p2pok.com/article/index.do?id=668" target="_blank">
		<p class="ry_p1">
		...
		<a href="http://www.p2pok.com/article/index.do?id=669" target="_blank">
		<p class="ry_p1">
