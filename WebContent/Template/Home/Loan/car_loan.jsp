...
<div class="hc_curpage_wper">
	   <div class="hc_curpage px1000 pt">
	   	      <a href="http://www.p2pok.com/"> 首页 </a><span>&gt;</span><a href="${_WEB_ROOT_}/loan/index.do"> 我要借款 </a><span>&gt;</span><a href="${_WEB_ROOT_}/loan/index.do"> 业务产品 </a><span>&gt;</span><a href="${_WEB_ROOT_}/loan/car_loan.do" class="curpage_ftcolor1"> 一般借款 </a>
	   </div>
</div>
<!-- end curpage -->
...
<div class="loan_con_1">
   <div class="loan_con_1_l fl">
      ...
      <ul>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>18-55周岁的中国公民</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>在现单位工作满3个月</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>月收入3000</li>
      </ul>
   </div>
   ...
   <div class="loan_con_1_c fl">
      ...
      <ul>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>借款额度：2000 - 50000</li>
         ...
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>审核时间：3个工作日内</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>还款方式：等额本息</li>
      </ul>
   </div>
   ...
   <div class="loan_con_1_r fl">
      ...
      <ul>
         ...
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>劳动合同或在职证明</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>近3个月工资卡银行流水</li>
      </ul>
   </div>
</div>
...
<div class="loan_con_2">
   ...
   <div class="loan_con_2_l fl">
      <h2><img src="${HomeStatics}/Loan/images/loan_tilte_2.png" /></h2>
       <ul>
         <li class="text">是指申请人以个人名下合法财产为保证措施，向投资者申请短期借贷的贷款业务。</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>手续简便</li>
         <li><span><img src="${HomeStatics}/Loan/images/loan_stars.png" /></span>审批快捷</li>
