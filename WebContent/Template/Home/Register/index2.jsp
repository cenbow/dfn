		...
		<div class="login_con ">
			...
			<div class="reg_con_box">
				<form>
					<fieldset>
						<div class="pb10">
							<label>用户名：</label> <input type="text" name="user_name" id="user_name" placeholder="请设置您的用户名" class="reg_input1" /> <span
						...
						<div>
							<label>登录密码：</label> <input type="password" name="pass_word"	id="pass_word" placeholder="请输入密码" class="reg_input1" /> <span
								class="reg_spantip">*</span>
						</div>
						<div class="pas_span pb10">
							<label style="height: 20px;"></label> <span class="pas_spancur">弱</span>
							<span>中</span> <span>高</span>
						</div>
						<div class="pb10 ">
						...
						<div class="pb20">
							...
							我已阅读并同意融圣360的<a href="http://www.rongsheng360.com/article/index.do?id=640" target="_blank" class="reg_ft01">服务条款</a>
						</div>
						<div>
...
function register(){
	...
	postData("${dfn:U('home/register/doRegister')}",p,function(d){
		if(d.status==1){
			...
			setTimeout(function(){ window.location.href="${dfn:U('thirdparty/tpsend/register')}"},2000);
		}
