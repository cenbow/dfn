...
.error{ width:600px;height:200px; position:absolute; top:50%; left:50%; margin-left:-200px; margin-top:-100px}
.error h1{line-height:50px; font-size:30px; color:#F00; font-family:微软雅黑;}
