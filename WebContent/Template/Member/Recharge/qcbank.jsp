...
<%@ include file="../Common/headerBody.jsp"%>
	...
	<div class="df_member_content_r" style="_width: 770px;">
		<h2 class="df_member_jfh2">
                	<a href="${dfn:SU(_thisUrl_,'index')}">在线充值</a>  <a href="javascript:;" style="background:#BBBBBB;">快捷卡</a>  <a href="${dfn:SU(_thisUrl_,'detail')}">充值记录</a>
        </h2>
		<div class="df_member_zfir">
                            ...
                            <table class="data_table m_t_b_20">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdValue">${cardInfo.bank_name}</tr>
                                    <tr>
                                        <td class="tdTitle">
                                            您银行账号户主姓名：
                                        </td>
                                        <td class="tdValue">
                                            <span id="spname">${useri.real_name}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tdTitle">
                                        ...
                                        <td class="tdValue">
                                            ${dfn:hideCard(cardInfo.bank_num,3,15)}</td>
                                    </tr>
                                    <tr>
                                        <td class="tdTitle">
                                            开户银行所在省份：
                                        </td>
                                        <td class="tdValue">${cardInfo.bank_province}</td>
                                    </tr>
                                    <tr>
                                        <td class="tdTitle">
                                            开户银行所在市：
                                        </td>
                                        <td class="tdValue">${cardInfo.bank_city}</td>
                                    </tr>
                        ...
                        <form id="addBankForm" name="addBankForm">
                            <table class="data_table m_t_b_20">
                                <tbody>
    ...
    <tr>
    <td colspan="2"><input type="checkbox">  我已阅读并同意<a style="color:#69c1ff" href="htttp://www.p2pok.com/article/index.do?id=673" target="_blank">《新浪支付快捷支付与银行卡变更协议》</a>
    </td>
    </tr>
                                    <tr>
                                        <td class="tdTitle">
...
function addBank(){
	...
	p['cid']=cid;
	Mix.load('提交中......');
	postData("${dfn:SU(_thisUrl_,'bindcard')}",p,function(d){
		if(d.status==1){
