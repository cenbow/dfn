...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${dfn:U('admin/commonly/task_index')}">计划任务</a></li>
			<li><a href="${dfn:U('admin/commonly/task_add')}" >添加新任务</a></li>
		  <li><a href="${dfn:U('admin/commonly/task_exeaction')}" >执守程序操作</a></li>
		</ul>
            ...
            <td width="20%" height="18" align="center">分钟</td>
						...
						<tbody>
							<tr>
								 ...
								 <td>13</td>
            <td class="tt">自动备份数据库</td>
            <td>每月</td>
            <td>每天</td>
            <td>16小时</td>
            <td>46分</td>
            <td><span class="green">开启</span></td>
            <td>
                <a href="/newadmin-Task-edit?id=13">修改</a>
                <a href="/newadmin-Task-delete?id=13" class="J_ajax_del">删除</a><br>
                <a href="javascript:;" onClick="showLog(13);">查看最后一次执行记录</a>
            </td>
