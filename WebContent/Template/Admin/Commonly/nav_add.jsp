...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="active.jsp">添加导航</a></li>
		</ul>
			...
			<div class="search_type cc mb10">
              ...
              <td><select name="parent_id">
                  <option value="0">作为一级菜单</option>
                     <option value='1' > 首页</option><option value='6' > 我要理财</option><option value='4' > 我要借款</option><option value='15' > 安全保障</option><option value='21' > 新手指引</option>                </select></td>
            </tr>
            <tr>
              <th width="200">是否新窗口打开：</th>
              <td><input type="radio" name="is_open" value="1" id="is_open_1" ><label for="is_open_1">是</label><input type="radio" checked="checked" name="is_open" value="0" id="is_open_2" ><label for="is_open_2">否</label></select></td>
            </tr>
            <tr>
              <th width="200">是否显示：</th>
              <td><input type="radio" checked="checked" name="is_show" value="1" id="is_show_1" ><label for="is_show_1">是</label><input type="radio" name="is_show" value="0" id="is_show_2" ><label for="is_show_2">否</label></select></td>
            </tr>
            <tr>
              <th width="200">显示名称：</th>
              <td><input  type="text" class="input" name="text" id="text" value=""/></td>
            </tr>
            <tr>
              <th width="200">链接地址：</th>
              <td><textarea rows="5" cols="40"  class="myarea" name="url" id="url" ></textarea></td>
            </tr>
