...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">会员充值统计</a></li>
  ...
  <div class="common-form">
    ...
    <th class="line_l">充值总手续费</th>
    <th class="line_l"><TABLE id="area_list" border="0" cellSpacing="0" cellPadding="0" width="100%">
      <THEAD>
        <TR jQuery18005471994194827372="2">
          <TH>充值总次数</TH>
        </TR>
      </THEAD>
    </TABLE></th>
