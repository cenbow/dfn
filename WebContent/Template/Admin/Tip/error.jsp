...
<base target="_self" />
<body>
<div class="error tip" style="position:absolute; width:800px; height:50px; left:50%; top:50%; margin-top:-25px; margin-left:-400px;">
	<img src="${AdminStatics}/tip/images/error.png"/> <span class="result">error</span> <span class="text">${message}</span>
</div>
</body>
</html>