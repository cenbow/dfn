					...
					<div class="search_type cc mb10">
						<div class="mb10">
							<span class="mr20">
							 ...
							 期数：							 
		                     ${dfForm:input( "bv#sort_order", defaultMap['bv#sort_order'], dfForm_class,  dfForm_style,dfForm_others)}
                              还款状态： 
							 ${dfForm:select( "bv#status",istatus, defaultMap['bv#status'], dfForm_class, "",dfForm_others)}
						    应还时间： 
