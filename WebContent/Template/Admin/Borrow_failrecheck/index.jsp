...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${dfn:U('admin/borrow_failrecheck/index')}">复审未通过</a></li>
		
	</ul>
	
	<div id = "indexPage" >
		<div class="wrap J_check_wrap" >
				<form class="well form-search" method="get"	action="${dfn:U('admin/borrow_failrecheck/index')}">
					<div class="search_type cc mb10">
						<div class="mb10">
							...
							借款标题：
							 ...
							 处理说明：
							  ${dfForm:input( "v#deal_info_2", defaultMap['v#deal_info_2'], dfForm_class, dfForm_style,dfForm_others)}
							 &nbsp;&nbsp;
