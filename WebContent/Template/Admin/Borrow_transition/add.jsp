...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li><a href="${dfn:U('admin/borrow_transition/index')}">流转中的借款</a></li>
			<li><a href="${dfn:U('admin/borrow_transition/edit')}">编辑流转标
			</a></li>
			<li class="active"><a
				href="${dfn:U('admin/borrow_transition/add')}">添加流转标 </a></li>
		</ul>
		...
		<form class="form-horizontal J_ajaxForm" name="myform" id="myform"
			action="${dfn:U('admin/borrow_transition/edit')}" method="post">
			<fieldset>
				<div class="tabbable">
					<div class="tab-content">
							...
							<table class="table_form" cellpadding="2" >
								<tbody>
									...
									<tr>
										...
										<td> <input class="input Wdate" 
								style="width: 100px;" type="text" onFocus="WdatePicker({lang:'zh-cn'})" name="deadline" value="${deadline}" /> <span
							...
							<table class="table_form" cellpadding="2" >
								<tbody>
									<tr>
										...
										<td><a
											href="${dfn:U('admin/borrow_transition/showuser')}?id=${user.id}"
						...
						<div class="tab-pane " id="D">
							<table class="table_form" cellpadding="2" >
								<tbody>
									<tr>
										<td class="control-label">原始债权金额：</td>
										<td>${dfForm:input( "contract_total", data['contract_total'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">原始债务人：</td>
										<td>${dfForm:input( "contract_owner", data['contract_owner'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">原始债权年化利率：</td>
										<td>${dfForm:input( "contract_interest", data['contract_interest'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">原始债权起止日期：</td>
										<td>${dfForm:input( "contract_end", data['contract_end'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">原始债权期限：</td>
										<td>${dfForm:input( "contract_month", data['contract_month'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">总流转期数：</td>
										<td>${dfForm:input( "contract_duration", data['contract_duration'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">流转总金额：</td>
										<td>${dfForm:input( "contract_money", data['contract_money'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
									<tr>
										<td class="control-label">每期流转份数：</td>
										<td>${dfForm:input( "contract_amount", data['contract_amount'], dfForm_class, dfForm_style,dfForm_others)}</td>
									</tr>
								</tbody>
							</table>
						</div>
