...
<body class="J_scroll_fixed">
	...
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="${dfn:U('admin/article/add_menu')}">添加文章
			</a></li>
		...
		<form  method="post" action="${dfn:U('admin/article/addArticle')}" id="form" class="form-horizontal J_ajaxForm">
			<div class="common-form cwh">
				<table>
					<tr>
						...
						<td><input type="radio" class="_RADIO_"	name="attr" value="1" id="cate_type_1" checked
									onclick="ckjump(this)"><label class="_RADIO_LABEL_CLASS_" for="cate_type_1">普通</label>
									<input
									type="radio" name="attr"  class="_RADIO_" value="2" id="cate_type_3" onClick="ckjump(this)"><label class="_RADIO_LABEL_CLASS_" for="cate_type_3">跳转</label>
					...
					<tr>
						...
						<td>${dfForm:input( "sort_order",sort_order, dfForm_class, dfForm_style,dfForm_others)}
					...
					<tr>
						...
						<td> 
                        	<input type="hidden" id="thumburl" name="thumburl" value="">
						 	<input type="file" name="thumb" id="thumb" />长<input type="text" style="width:100px" id="twidth" value=""> 宽<input style="width:100px" type="text" id="theight" value="">
                            <span id="loading_thumb" style="display:none"><img src="${SiteStatics}/Common/images/loadingmini.gif" /></span>
                            <div id="show_img">
