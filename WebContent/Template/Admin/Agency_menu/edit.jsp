...
<body class="J_scroll_fixed">
	<div class="wrap jj" >
		...
		<li ><a href="${dfn:U('admin/agency_menu/add_menu')}">添加菜单</a></li>
		</ul>
		<form method="post" 
			action="${dfn:U('admin/agency_menu/editAgency_menu')}" class="form-horizontal J_ajaxForm">
				...
				<table>
					...
					<tr>
						<th class="control-label">备注：</th>
							<td><textarea name="remark" rows="5" cols="57">${data['remark'] }</textarea>
