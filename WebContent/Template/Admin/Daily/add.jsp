...
<script type="text/javascript">var mysn1=0;var mysn2=10000;</script>
	<div class="wrap J_check_wrap">
		...
		<form class="form-horizontal J_ajaxForm" name="myform" id="myform" action="${dfn:U('admin/daily/doadd')}" method="post">
							...
							<div class="table_full">
								<table width="100%" class="table_form ">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="input Wdate" 	style="width: 200px;" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" name="end_count_time" value="${end_count_time}" /></td>
                                    </tr>
									<tr>
