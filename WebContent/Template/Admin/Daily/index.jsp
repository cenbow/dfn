...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${dfn:U('admin/daily/index')}">日息宝列表</a></li>
		<li><a href="${dfn:U('admin/daily/add')}">添加</a></li>
	</ul>
	
	<div id = "indexPage" >
		<div class="wrap J_check_wrap" >
				<form class="well form-search" method="get"	action="${dfn:U('admin/daily/index')}">
