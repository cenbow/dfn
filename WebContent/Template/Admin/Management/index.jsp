...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${dfn:U('admin/management/index')}">管理员列表</a></li>
			<li><a href="${dfn:U('admin/management/user_add')}">添加管理员 </a></li>
		</ul>

		<div id="indexPage">
			<div class="wrap J_check_wrap">
				<form class="well form-search" method="get"
					action="${dfn:U('admin/management/index')}">
					<div class="search_type cc mb10">
						<div class="mb10">
							<span class="mr20"> 最后登陆时间： <input class="input Wdate" style="width: 100px;"
								...
								客服： ${dfForm:select( "au#is_kf",iskfSelect, defaultMap['au#is_kf'], dfForm_class, dfForm_style,dfForm_others)}
								...
								真实姓名： ${dfForm:input( "au#real_name", defaultMap['au#real_name'], dfForm_class, dfForm_style,dfForm_others)}
