...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${dfn:U('admin/borrow_recheck/index')}">发标初审</a></li>
		<li ><a href="${dfn:U('admin/borrow_recheck/menu')}">复审审核 </a></li>
	</ul>
	
	<div id = "indexPage" >
		<div class="wrap J_check_wrap" >
				<form class="well form-search" method="get"	action="${dfn:U('admin/borrow_recheck/index')}">
