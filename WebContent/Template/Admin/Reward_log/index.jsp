...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${dfn:U('admin/reward_log/index')}">会员奖金变动记录</a></li>
		
	</ul>
	
	<div id = "indexPage" >
		<div class="wrap J_check_wrap" >
				<form class="well form-search" method="get"	action="${dfn:U('admin/reward_log/index')}">
						...
						<div class="mb10">
						   ...
						   交易时间： 
							 <input class="input Wdate" style="width: 100px;"
								...
								&nbsp;
								<input type="button" class="btn" id="toExcel" value="导出" onclick="excel('${dfn:U('admin/reward_log/toExcel')}');">
