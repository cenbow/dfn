...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#">正在还款</a></li>
		</ul>
		<div class="wrap J_check_wrap">
			<form class="well form-search" method="post"
				...
				<div class="search_type cc mb10">
					<div class="mb10">
						<span class="mr20">标号： <input style='width: 100px'
							type="text" class="input" name="b#id" id="b#id" value="" /> 会员名：
							<input style='width: 100px' type="text" class="input"
							name="m#user_name" id="m#user_name" value="" /> 借款标题： <input
							style='width: 100px' type="text" class="input"
							name="bi#borrow_name" id="bi#borrow_name" value="" /> 所属客服： <input
							style='width: 100px' type="text" class="input"
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th align="center" valign="middle">已还金额</th>
								<th align="center" valign="middle">还款方式</th>
								<th align="center" valign="middle">借款期限</th>
								<th align="center" valign="middle">即将还款日期</th>
								<th align="center" valign="middle">即将还款金额</th>
								<th align="center" valign="middle">本金</th>
								<th align="center" valign="middle">利息</th>
								<th align="center" valign="middle">期数</th>
								<th align="center" valign="middle">借款手续费</th>
								<th align="center" valign="middle">还款最终限期</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><a href="javascript:;"
									onClick="newiframe('borrow_n_109','/newadmin-borrow_detail-index-borrow_id-109.shtml','109号标详情');">店铺资金周转</a></td>

								<td align="center" valign="middle">信用标</td>
								<td align="center" valign="middle">500.00</td>

								<td align="center" valign="middle">0</td>

								<td align="center" valign="middle">按月分期还款</td>
								<td align="center" valign="middle">1个月</td>
								<td align="center" valign="middle">2015-02-14 23:59:59</td>
								<td align="center" valign="middle">￥500.60</td>
								<td align="center" valign="middle">￥500.60</td>
								<td>￥0.60</td>
								<td>1/1</td>
								<td>5.00</td>
								<td>2015-02-14 23:59</td>
