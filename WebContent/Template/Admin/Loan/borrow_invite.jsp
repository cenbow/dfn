...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${dfn:U('admin/loan/borrow_invite')}">正在招标</a></li>
			<li><a href="${dfn:U('admin/loan/borrow_invite_edit')}" >复审审核</a></li>
		</ul>
					...
					<table class="table table-hover" width="100%">
						...
						<tbody>
							<tr>
								...
								<td align="center" valign="middle">80.00</td>
								<td align="center" valign="middle">2015-03-17 11:39:42</td>
								<td align="center" valign="middle">   <a href="javascript:;" onClick="dialogUrl('/newadmin-BorrowInvite-edit?id=127','流标或者延长募集时间','','',470);">流标|延时</a>&nbsp;&nbsp; 
							</td>
