				...
				<div class="search_type cc mb10">
					<div class="mb10">
						<span class="mr20">产品名称： <input style='width: 100px'
							...
							value="" />
						投资人： <input style='width: 100px' type="text"
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th align="center" valign="middle">投资金额</th>
								<th align="center" valign="middle">获得收益</th>

								<th align="center" valign="middle">投资时间</th>
