...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#">发标初审</a></li>
		</ul>
			...
			<form class="J_ajaxForm" action="" method="post">
				<div class="table_list">
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
																<th width="48" align="center" valign="middle">ID</th>
								<th width="150" align="center" valign="middle">借款人</th>
								<th width="48" align="center" valign="middle">借款种类</th>
								<th width="65" align="center" valign="middle">标题</th>
								<th width="52" align="center" valign="middle">借款金额</th>
								<th width="77" align="center" valign="middle">还款方式</th>
								<th width="137" align="center" valign="middle">借款期限</th>
								<th width="52" align="center" valign="middle">借款手续费</th>
								<th width="150" align="center" valign="middle">提交借款时间</th>
								<th width="50" align="center" valign="middle">操作</th>
							</tr>
						</thead>
						<tbody>
							<tr>
