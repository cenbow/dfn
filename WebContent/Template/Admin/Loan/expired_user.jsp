...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="expired_user.jsp">逾期借款会员</a></li>
		</ul>
        ...
        <select class="select_2" name="searchtype" style="width:70px;"> <option value='0' >标题</option> </select>         -->
						...
						<input name="submit" type="submit" class="btn" onClick="window.open('/newadmin-BorrowExpiredUser-export?');return false;" value="导出">
						</span></div>
				</div>
			</form>
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th align="center" valign="middle">客服</th>
								<th align="center" valign="middle">总逾期期数</th>

								<th align="center" valign="middle">总逾期金额</th>
								<th align="center" valign="middle">总逾期本金</th>
								<th align="center" valign="middle">总逾期利息</th>
						...
						<tbody>
							<tr>
								...
								<td align="center" valign="middle"><a target="_blank"
									href="/newadmin-common-user-user_name-22.shtml">22</a></td>




								<td align="center" valign="middle">赵婧</td>
								...
								<td align="center" valign="middle">1期</td>

								<td align="center" valign="middle">3480.67元</td>
								<td align="center" valign="middle">3230.67元</td>
								<td align="center" valign="middle">250.00元</td>
