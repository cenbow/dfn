				...
				<div class="search_type cc mb10">
					<div class="mb10">
						<span class="mr20"> 会员名：
							...
							name="bi#borrow_name" id="bi#borrow_name" value="" />
							所属客服： <input
							style='width: 100px' type="text" class="input"
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th align="center" valign="middle">借款标种类</th>
						...
						<tbody>
							<tr>
								...
								<td align="center" valign="middle"><a>93</a></td>
								 <td><a href="/invest-borrow-id-131.shtml" target="_blank"><a href="javascript:;" onClick="newiframe('borrow_n_131','/newadmin-borrow_detail-index-borrow_id-131.shtml','131号标详情');">测试标（2）</a></td>



								<td align="center"><a href="javascript:;" onClick="newiframe('borrow_n_119','/newadmin-borrow_detail-index-borrow_id-119.shtml','119号标详情');">担保标1</a></td>

								<td align="center" valign="middle">500.00</td>

								<td align="center" valign="middle">担保标</td>
								...
								<td align="center" valign="middle">0.00</td>
									<td align="center" valign="middle">2015-04-17 23:59</td>
