...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${dfn:U('admin/loan/transition_index')}">流转中的借款</a></li>
			<li><a href="${dfn:U('admin/loan/transition_edit')}" >编辑流转标</a></li>
		  <li><a href="${dfn:U('admin/loan/transition_add')}" >添加流转标</a></li>
		</ul>
		<div class="wrap J_check_wrap">
			<form class="well form-search" method="post"
				...
				<div class="search_type cc mb10">
					<div class="mb10">
						<span class="mr20"> 借款人： <input style='width: 100px'
						...
						借款周期： <input style='width: 100px' type="text" class="input"
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th  align="center" valign="middle">总流转数</th>
								<th  align="center" valign="middle">已流转数</th>
								<th  align="center" valign="middle">借款时间</th>
								<th  align="center" valign="middle">流转结束时间</th>
