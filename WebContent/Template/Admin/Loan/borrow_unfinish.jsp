...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#">已流标</a></li>
		</ul>
					...
					<table class="table table-hover" width="100%">
						<thead>
							<tr>
								...
								<th align="center" valign="middle">处理时间</th>
								<th align="center" valign="middle">处理说明</th>
						...
						<tbody>
							<tr>
								...
								<td align="center" valign="middle">按天到期还款</td>

								<td align="center" valign="middle">1个月</td>
								<td align="center" valign="middle">2015-03-10 17:08</td>
								<td align="center" valign="middle">无法投标</td>
