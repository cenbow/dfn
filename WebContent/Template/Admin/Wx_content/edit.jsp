...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		...
		<form method="post" action="${dfn:U('admin/wx_content/doedit')}" class="form-horizontal J_ajaxForm">
        <input type="hidden" value="${data.id}" id="id" name="id"/>
			<div class="common-form cwh">
                ...
                <div class="table_full">
                  <table width="100%" class="table_form ">
                    <tr>
                      ...
                      <td>${dfForm:radio("msg_type",typeSelect,data['msg_type'],"","","onclick='showwx(this);'")}</td>
                    </tr>
                    <tr>
                      <th>标题：</th>
                ...
                <div class="table_full wxcontents" id="wx_text" <c:if test="${data['msg_type']=='news'}">style="display:none"</c:if>>
                  <table width="100%" class="table_form ">
                     <tr>
                      <td colspan="2"><textarea rows="5" cols="40" class="myarea" name="content" id="content">${data.content}</textarea></td>
                    </tr>
                  </table>
                </div>
                <div class="table_full wxcontents" id="wx_news" <c:if test="${data['msg_type']=='text'}">style="display:none"</c:if>>
