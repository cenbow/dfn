...
<body class="J_scroll_fixed">
	...
	<div class="wrap jj">
		...
		<li ><a href="${dfn:U('admin/menu/add_menu')}">添加子菜单  </a></li>
		</ul>
		<form method="post" action="${dfn:U('admin/menu/editMenu')}" class="form-horizontal J_ajaxForm">
			<div class="common-form cwh">
				...
				<table>
					<tr>
						...
						<td>
							${dfForm:select( "parentid",parentid_Select, data['parentid'], dfForm_class,  dfForm_style,dfForm_others)}
						</td>
					</tr>
