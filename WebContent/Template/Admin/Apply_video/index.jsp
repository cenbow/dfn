...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${dfn:U('admin/apply_video/index')}">视频认证申请</a></li>
	</ul>
	
	<div id = "indexPage" >
		<div class="wrap J_check_wrap" >
				<form class="well form-search" method="get"	action="${dfn:U('admin/apply_video/index')}">
					<div class="search_type cc mb10">
						<div class="mb10">
							...
							认证状态：
							 ${dfForm:select( "v#apply_status",video_statusSelect, defaultMap['v#apply_status'], dfForm_class, dfForm_style,dfForm_others)}
