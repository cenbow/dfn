...
<body class="J_scroll_fixed">
	...
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="${dfn:U('admin/user/index')}">会员列表</a></li>
			<li class="active"><a href="${dfn:U('admin/user/user_add')}">添加会员
			</a></li>
		</ul>
		<ul class="nav nav-tabs">
		...
		<form method="post" action="${dfn:U('admin/user/addUser')}"
			...
			<div class="common-form cwh">
				...
				<table>
					...
					<tr>
						<th width="200" class="control-label">会员名： <input
					...
					<tr>
						...
						<td>${dfForm:select( "is_transfer",memberTypeSelect, data['is_transfer'], dfForm_class, dfForm_style,dfForm_others)}
					...
					<tr>
						...
						<td>${dfForm:input( "re_user_pass", "", dfForm_class, dfForm_style,dfForm_others)}
							...
							class="commonToolTip">如不修改则留空</span>
						</td>
					</tr>
					<tr>
