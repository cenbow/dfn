...
public class BaseAppController extends MultiActionController{
	private static Log logger = LogFactory.getLog(BaseAppController.class);
	...
	public ModelAndView getTplView(HttpServletRequest request, HttpServletResponse response, String mPath, ModelAndView mv) {
		...
		mv.addObject("AppStatics",WEB_ROOT+"/Statics/App/");
		String tplPath = "/App/" + mPath + "/" + actionName;
		mv.addObject("_thisUrl_","App/" + mPath + "/");
//		System.out.println("tplPath="+tplPath);
	...
	public ModelAndView showTip(ModelAndView mv,String tipType,String showSecond,String msg,String jumpUrl) {
		...
		String tplPath = "/Home/Common/tip_mob_"+tipType;
		mv.setViewName(tplPath);
		return mv;
	}
