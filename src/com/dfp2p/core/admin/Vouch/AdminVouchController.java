package com.dfp2p.core.admin.Vouch;
...
@Controller
public class AdminVouchController extends BaseAdminController {
	public String tplPath = "Vouch";
...
public ModelAndView index(HttpServletRequest request, HttpServletResponse response, ModelAndView mv) {
		...
		Map<String, Object> list = (Map<String, Object>) ConfigCache.getCacheList("Vouch");
	...
	public void editVouch(HttpServletRequest request, HttpServletResponse response, ModelAndView mv) throws IOException {
		PageData pd = new PageData(request);
		
		Tools.printData(PageData.sortRequestMap(pd.post()));
		
		boolean flag = ConfigCache.doEditCache("Vouch",PageData.sortRequestMap(pd.post()));
