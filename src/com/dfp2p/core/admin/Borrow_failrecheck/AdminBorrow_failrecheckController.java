package com.dfp2p.core.admin.Borrow_failrecheck;
...
import com.dfp2p.core.admin.Borrow_failcheck.AdminBorrow_failcheckService;
...
@Controller
public class AdminBorrow_failrecheckController extends BaseAdminController {
	public String tplPath = "Borrow_failrecheck";
	
	@Resource(name="adminBorrow_failrecheckService")
	private AdminBorrow_failrecheckService thisService;
	...
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response, ModelAndView mv) {
		...
		HashMap<String, Object> list = thisService.getBorrow_failrecheckList(pd, mv);
