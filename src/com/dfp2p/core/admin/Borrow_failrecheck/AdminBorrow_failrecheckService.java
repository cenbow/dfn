...
@Service("adminBorrow_failrecheckService")
public class AdminBorrow_failrecheckService{

	private static Log logger = LogFactory.getLog(AdminBorrow_failrecheckService.class);
	
	@Resource(name="adminBorrow_failrecheckDao")
	private AdminBorrow_failrecheckDao thisDao;
	
	@Resource(name="baseService")
	private BaseService baseService;
	

	public HashMap<String, Object> getBorrow_failrecheckList(PageData pd,
			ModelAndView mv) 
		{
