...
@Service("adminBorrow_doneService")
public class AdminBorrow_doneService{

	private static Log logger = LogFactory.getLog(AdminBorrow_doneService.class);
	
	@Resource(name="adminBorrow_doneDao")
	private AdminBorrow_doneDao thisDao;
	...
	public HashMap<String, Object> getBorrow_doneList(PageData pd,
			ModelAndView mv) 
		{
		...
		whereUtil.getStringCondition("borrow_status", "7", "=");
		...
		try{
			...
			list = thisDao.getBorrow_doneList(conn, rp);
		} catch (Exception e) {
